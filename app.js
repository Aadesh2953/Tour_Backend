...
const addTour=(req,res)=>
    {
        ...
        tours.push(newTour)
        fs.writeFile("./dev-data/data/tours-simple.json",JSON.stringify(tours),(data,err)=>
        {
...
app.route('/api/v1/tour/:id').post(getTourById).patch(updateTourById).delete(deleteTourById)
app.listen(3000,()=>{
